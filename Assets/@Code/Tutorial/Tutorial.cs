...
public class Tutorial : MonoBehaviour {
    ...
    private void Update() {
        ...
        else if(step == 33 && Vector3.Distance(carcon.transform.position, gasStationTarget.GetComponent<Transform>().position) < 10) NextStep();
    ...
    public void NextStep() {
        ...
        else if(step == 14) nm.NewNotif("TONDOO", "For this tutorial, you'll only have FACTORY as the LOCKED landmark. And since TONDOO is on the way there, turn it on so you can unload passengers along the way.\n\n([LEFT CLICK] 'TONDOO' to turn ON)");
