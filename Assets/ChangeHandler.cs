...
public class ChangeHandler : MonoBehaviour {//, ITooltipable, IScrollable {
    // private List<PersonController> changees = new List<PersonController>();
    // public PersonController currentChangee;
    ...
    //     } else {
    //         foreach(PersonController changee in changees) {
    ...
    // public void AddChangee(PersonController changee) {
    ...
    //     currentChangee = null;
    //     List<PersonController> clearList = new List<PersonController>();
    //     foreach(PersonController changee in changees) {
    //         clearList.Add(changee);
    //     }
    //     foreach(PersonController changee in clearList) {
    //         RemoveChangee(changee);
    //     }
    // }

    // public void RemoveChangee(PersonController changee) {
    //     // changee.GetComponent<Outline>().enabled = false;
